        ...
        String sql = new SQL() {
            {
                ...
                if (params.get("employee") != null) {
                    ...
                    if (employee.getDept() != null && employee.getDept().getId() != null && employee.getJob().getId() != 0) {
        ...
        return new SQL() {
            {
                SELECT("count(*)");
                FROM(EMPLOYEETABLE);
                if (parmas.get("employee") != null) {
                    Employee employee = (Employee) parmas.get("employee");
                    if (employee.getDept() != null && employee.getDept().getId() != null && employee.getDept().getId() != 0) {
                        WHERE("DEPT_ID=#{employee.dept.id}");
                    }

                    if (employee.getJob() != null && employee.getJob().getId() != null && employee.getJob().getId() != 0) {
                        WHERE("JOB_ID =#{employeejob.id}");
